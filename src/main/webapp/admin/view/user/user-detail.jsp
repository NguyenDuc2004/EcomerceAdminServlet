...
<div class="container-fluid">
    <div class="mb-4">
        <a href="${pageContext.request.contextPath}/user" class="btn btn-sm btn-light border shadow-sm px-3">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm pt-4 overflow-hidden">
                <div class="text-center px-3">
                    <img src="https://ui-avatars.com/api/?name=${user.username}&size=128&background=random&color=fff"
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-sm-4">
                            <p class="text-muted small fw-bold text-uppercase mb-1">Tên đăng nhập</p>
                    ...
                    <div class="bg-light p-3 rounded-3">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="mb-0 fw-bold text-dark">${user.roleName}</p>
                            </div>
                        </div>
                    </div>
