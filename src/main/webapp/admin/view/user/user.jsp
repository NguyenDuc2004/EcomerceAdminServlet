...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <c:if test="${sessionScope.loginedUser.roleName == 'ADMIN'}">
            ...
            <form action="${pageContext.request.contextPath}/user" method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <select name="role" class="form-select bg-light">
                        ...
                        <option value="USER" ${param.role == 'USER' ? 'selected' : ''}>Khách hàng</option>
                    </select>
                </div>
    ...
    <div class="card border-0 shadow-sm overflow-hidden">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tr>
                    <th class="ps-4 py-3">DANH TÍNH</th>
                    <th>VAI TRÒ</th>
                    <th>TRẠNG THÁI</th>
                    <th>NGÀY TẠO</th>
                ...
                <c:forEach items="${listUser}" var="u">
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${u.roleName == 'ADMIN'}"><span class="badge badge-admin">ADMIN</span></c:when>
                                <c:when test="${u.roleName == 'STAFF'}"><span class="badge badge-staff">STAFF</span></c:when>
                        ...
                        <div class="card border-0 shadow-sm p-3 h-100">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control" required placeholder="minhduc2">
                                </div>
                            </div>
                            <div class="mb-0">
...
<script>
    function confirmDelete(id) {
        if (confirm("Xác nhận xóa tài khoản này? Thao tác này sẽ xóa vĩnh viễn dữ liệu!")) {
